...
export async function POST(_req: NextRequest, props: Params) {
  ...
  try {
    ...
    // If retrieval fails, fall through to a plain refund. Worst case
    // Joinzer eats the cost rather than the refund failing entirely;
    // organizer reconciliation can be handled manually if it happens.
  }
