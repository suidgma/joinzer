...
export default async function LeagueRosterPage(props: { params: Promise<{ id: string }> }) {
  ...
  // Box + ladder do their seeding on the Run Session surface (box: seed boxes;
  // ladder: set the starting order before session 1), so the Roster is
  // registration-only for both.
